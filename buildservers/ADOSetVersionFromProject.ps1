...
Write-Host "OctopusVersionNumber: $octopusVersionNumber"
Write-Host "OctopusEnvironment: $octopusEnvironment"
Write-Host "OctopusChannel: $octopusChannel"
Write-Host "OctopusTenant: $octopusTenant"

Write-Host "##vso[task.setvariable variable=octopus.release.number]$octopusVersionNumber"
Write-Host "##vso[task.setvariable variable=octopus.environment.name]$octopusEnvironment"
Write-Host "##vso[task.setvariable variable=octopus.channel.name]$octopusChannel"
Write-Host "##vso[task.setvariable variable=octopus.tenant.name]$octopusTenant"